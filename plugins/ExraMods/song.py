...
def song(client, message):
    ...
    try:
        ...
        for i in range(len(dur_arr)-1, -1, -1):
            ...
            secmul *= 60
        message.reply_audio(audio_file, caption=rep, parse_mode='md',quote=False, title=title, duration=dur, performer=performer, reply_to_message.id=message.message.id, thumb=thumb_name)
        m.delete()
    except Exception as e:
        m.edit("**🚫 𝙴𝚁𝚁𝙾𝚁 🚫**")
        print(e)
